...
export default function MarketplacePage() {
  ...
  const productQuery = useMemoFirebase(() => {
    ...
    // Note: Firestore has limitations on multiple inequality filters + order by
    // For MVP, we'll keep sorting simple. 
  ...
  // Client-side search filter as Firestore doesn't support partial string matching easily
